 ...
 *
 * No `LeagueStatusBar` here, unlike My Picks and Standings. This screen is about
 * the player, not the league's state this week, and the design gives the page
 * its own centred title — a full-bleed week/survivors bar above it would be
